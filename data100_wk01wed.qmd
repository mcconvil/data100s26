...
[DATA 100 <br> Week 1 \| Spring 2026]{.custom-subtitle}
:::
:::::

------------------------------------------------------------------------

## Getting Started in DATA 100

#### Step 1: Check out the links in the "Useful Information" section on Moodle

![](img/moodle_useful_information.png){width="85%"}

------------------------------------------------------------------------

## DATA 100 Tech & Materials {.center}

![](img/structures.png){width="55%"}

------------------------------------------------------------------------

## Announcements

-   Lecture slide decks will be posted and linked to a Moodle Module the day before lecture.

    -   Will also bring printed versions for those who prefer paper copies.

-   Lab starts this week: Fridays 3 - 3:50pm
...
```{r, echo = FALSE, dev.args = list(bg = 'transparent'), fig.asp = .6, out.width = '80%', eval = FALSE}
...
## DATA 100 is about developing our **statistical thinking** and **coding** skills. {.center}
...
# Goal: Start collecting data from your life so that you can visualize it on P-Set 01.
...
![](img/complaints.jpg){width="100%" fig-align="center"}

------------------------------------------------------------------------

### Dear Data Examples

![](img/time.jpg){width="100%" fig-align="center"}
...
## Goal: Tomorrow, collect data from your life so that you can visualize it on P-Set 1.
...
-   Make sure to go through the syllabus, which can be found on Moodle.

    -   Will discuss assessments and course policies on Monday.

-   Lab starts on Friday!
