...
::: {style="margin-top: 80px; font-size: 1.2em; color: #19647E;"}
Waitlisters: Go to [bit.ly/stat-100-wait](https://bit.ly/stat-100-wait) to sign-in.
:::
...
[Stat 100 <br> Week 1 \| Spring 2024]{.custom-subtitle}
:::
:::
...
![](img/structures.001.jpeg){width="55%"}
