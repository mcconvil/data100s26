...
[DATA 100 <br> Week 9 \| Spring 2026]{.custom-subtitle}
:::
:::
...
::: nonincremental
-   Map making in `R` workshop: Part of the Sustainability Symposium
    -  Th, March 26, 2:30 - 3:50pm, Taylor 210
:::
...
-   More examples of confidence intervals in `R`
...
## Sampling Distribution Under No ESP {.smaller}
...
```{r, eval = FALSE}
guess_sampling_dist <- do(1000)*rflip(n = 119, prob = 0.25)
p_hat <- 42/119
